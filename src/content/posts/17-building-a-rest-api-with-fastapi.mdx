...
![python-venv](../../posts/17/assets/python-venv.png)
...
![hello-world](../../posts/17/assets/hello-world.png)
...
![database](../../posts/17/assets/database.png)
...
![create book](../../posts/17/assets/create-book.png)
...
![created record](../../posts/17/assets/created-record.png)

You can add a few more books to the database before we continue. Here's what my database looks like:

![all created books](../../posts/17/assets/all-created-books.png)
...
![list all books](../../posts/17/assets/list-books.png)
...
![show single book](../../posts/17/assets/single-book.png)
...
![update book](../../posts/17/assets/update-book.png)
...
![delete book](../../posts/17/assets/delete-book.png)
