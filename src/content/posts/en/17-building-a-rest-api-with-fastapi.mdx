...
![virtual environment activated in terminal](../../../assets/posts/17/python-venv.png)
...
<Callout type="info">
    ...
    <code>pip freeze > requirements.txt</code>. This will create a{' '}
    <code>requirements.txt</code> file in your project root directory.
</Callout>
...
![fastapi hello world](../../../assets/posts/17/hello-world.png)

<Callout type="info">
    Your browser may show the result in a different way, I'm using a chrome
    extension called JSON Viewer to format the JSON response.
</Callout>
...
![fastapi interactive docs](../../../assets/posts/17/docs.png)
...
<Callout type="info">
    SQLAlchemy is a Python SQL ORM (Object Relational Mapper) that makes it easy
    to interact with a database using Python. It supports multiple database
    engines including SQLite and PostgreSQL.
</Callout>
...
![database loaded from dbeaver](../../../assets/posts/17/database.png)

<Callout type="warn">
    Because this is a simple example, we're creating the database and table as
    soon as our application starts. In a real productions application, you'll
    probably want to use something like Alembic to manage your database
    migrations.
</Callout>
...
![create new book record](../../../assets/posts/17/create-book.png)
...
![created record](../../../assets/posts/17/created-record.png)

You can add a few more books to the database before we continue. Here's what my database looks like:

![all created records](../../../assets/posts/17/all-created-books.png)
...
![list all books](../../../assets/posts/17/list-books.png)
...
<Callout type="info">
    Notice the use of an `HTTPException` to raise a 404 response if the book is
    not found. We import the <code>HTTPException</code> class from the{' '}
    <code>fastapi.exceptions</code> module.
</Callout>
...
![get a single book](../../../assets/posts/17/single-book.png)
...
<Callout type="info">
    Notice the use of the <code>BookUpdate</code> model. This model is similar
    to the <code>Book</code> model but it doesn't have the <code>id</code>{' '}
    field. This is because we don't want to allow the user to update the{' '}
    <code>id</code> field.
</Callout>
...
![update a book](../../../assets/posts/17/update-book.png)
...
![delete a book](../../../assets/posts/17/delete-book.png)
