...
![create new post](../../assets/posts/04/create-new-post.png)
...
![sanity local server](../../assets/posts/04/sanity-studio-local-server.png)
...
![add local server](../../assets/posts/04/add-local-server.png)
