...
![sanity local server](../../posts/04/assets/sanity-studio-local-server.png)
...
![sanity project id](../../posts/04/assets/sanity-project-id.png)
...
![add local server](../../posts/04/assets/add-local-server.png)
...
![create new post](../../posts/04/assets/create-new-post.png)
