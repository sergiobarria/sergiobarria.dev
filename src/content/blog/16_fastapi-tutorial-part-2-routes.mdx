...
slug: 'fastapi-tutorial-part-2-routes'
...
coverImage: 'https://ik.imagekit.io/l5swuiqdn/personal-website/16-fastapi-tutorial-p2_i6lk0e.png'
isFeatured: false
keywords:
  - FastAPI
  - Python
...
import CalloutBox from '~/shared/components/svelte/CalloutBox.svelte';
...
All the files for this and the other sections are stored in this [repo](https://github.com/sergiobarria/sergiobarria.com-astro). Each part of the series has a corresponding branch and the `main` branch includes the finished project.
...
<Image
	src="https://ik.imagekit.io/l5swuiqdn/personal-website/api-title-description_r6kmoe.png?ik-sdk-version=javascript-1.4.3&updatedAt=1673933288243"
...
<CalloutBox type="info">
	To update books, we're using a function provided by FastAPI `jsonable_encoder`. Basically this
	function will convert a Pydantic schema into JSON format.
</CalloutBox>

<CalloutBox type="info">
	At this point we have the complete `CRUD` operations for our books. In the next post, we'll add
...
<Image
	src="https://ik.imagekit.io/l5swuiqdn/personal-website/endpoint-with-query-params_wv2k0k.png?ik-sdk-version=javascript-1.4.3&updatedAt=1673933288657"
...
<Image
	src="https://ik.imagekit.io/l5swuiqdn/personal-website/endpoint-with-query-params-response_idfryj.png?ik-sdk-version=javascript-1.4.3&updatedAt=1673933289708"
...
<Image
	src="https://ik.imagekit.io/l5swuiqdn/personal-website/api-books-authors-routes_mmzmdl.png?ik-sdk-version=javascript-1.4.3&updatedAt=1673933288452"
	alt="endpoint with query params response"
/>
