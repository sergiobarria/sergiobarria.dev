...
coverImage: 'sergiobarria/banners/16-fastapi-tutorial-p2_i6lk0e.png'
isFeatured: false
keywords:
  - FastAPI
  - Python
...
import { CalloutBox, CldImage } from '~/shared/components/jsx';
...
<CldImage
	publicId="sergiobarria/posts/fastapi-tutorial-part-2-routes/api-title-description_r6kmoe.png"
...
<CldImage
	publicId="sergiobarria/posts/fastapi-tutorial-part-2-routes/endpoint-with-query-params_wv2k0k.png"
...
<CldImage
	publicId="sergiobarria/posts/fastapi-tutorial-part-2-routes/endpoint-with-query-params-response_idfryj.png"
...
<CldImage
	publicId="sergiobarria/posts/fastapi-tutorial-part-2-routes/api-books-authors-routes_mmzmdl.png"
	alt="endpoint with query params response"
/>
