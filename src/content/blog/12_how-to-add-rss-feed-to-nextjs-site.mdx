...
slug: 'how-to-add-rss-feed-to-next-js-site'
publishedDate: '2021-07-28'
summary: In this post we\'ll see an easy way to add an rss feed to your Next.Js website without writing XML'
coverImage: 'https://ik.imagekit.io/l5swuiqdn/personal-website/how-to-add-rss-feed_ovuyjn.png'
isFeatured: false
---
