...
export function SpotifyCard() {
	...
	return (
		<div className={styles.spotify}>
			...
			<div>
				<a href="#">{data?.isPlaying ? <span>{data?.title}</span> : <span>Not Listening</span>}</a>

				{data?.isPlaying ? (
					<div className={styles.subcontent}>
						<span className={styles.subheader}>{data?.artist}</span>
					...
					<span className={styles.subheader}>Spotify</span>
				)}
			</div>
		</div>
	);
