...
![creating new posts](../../../assets/posts/04/create-new-post.png)
...
![creating new posts](../../../assets/posts/04/sanity-studio-local-server.png)
...
![sanity project id](../../../assets/posts/04/sanity-project-id.png)
...
![adding sanity studio local server to CORS origin](../../../assets/posts/04/add-local-server.png)
