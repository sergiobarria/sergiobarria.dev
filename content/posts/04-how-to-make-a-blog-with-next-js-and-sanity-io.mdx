...
description: Let's learn how to create a blog website using Next.js and the headless CMS Sanity.
draft: false
---
...
<Image src="/posts/04/create-new-post.png" alt="create new post" width={2800} height={1806} />
...
<Image
    src="/posts/04/sanity-studio-local-server.png"
    alt="sanity local server"
    width={2800}
    height={1806}
/>
...
<Image src="/posts/04/sanity-project-id.png" alt="sanity project id" width={2800} height={1806} />
...
<Image src="/posts/04/add-local-server.png" alt="add local server" width={2800} height={1806} />
