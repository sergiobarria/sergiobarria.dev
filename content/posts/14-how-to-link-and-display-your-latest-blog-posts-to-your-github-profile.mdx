...
description: In this guide, we'll see an easy way of linking our latest blog posts to our Github profile using a 3rd party package.
draft: false
---
...
<Image src="/posts/14/run-workflow.png" alt="run workflow" width={2800} height={1806} />
...
<Image src="/posts/14/final-result.png" alt="final result" width={2800} height={1806} />
