...
<Image src="/posts/17/python-venv.png" alt="python-venv" width={331} height={66} />
...
<Image src="/posts/17/hello-world.png" alt="hello-world" width={374} height={142} />
...
<Image src="/posts/17/docs.png" alt="docs" width={2860} height={1490} />
...
<Image src="/posts/17/database.png" alt="database" width={1136} height={709} />
...
<Image src="/posts/17/create-book.png" alt="create book" width={2312} height={1306} />
...
<Image src="/posts/17/created-record.png" alt="created record" width={1136} height={344} />

You can add a few more books to the database before we continue. Here's what my database looks like:

<Image src="/posts/17/all-created-books.png" alt="all created books" width={823} height={226} />
...
<Image src="/posts/17/list-books.png" alt="list all books" width={2800} height={1806} />
...
<Image src="/posts/17/single-book.png" alt="show single book" width={2796} height={1546} />
...
<Image src="/posts/17/update-book.png" alt="update book" width={2106} height={1682} />
...
<Image src="/posts/17/delete-book.png" alt="delete book" width={2866} height={1482} />
